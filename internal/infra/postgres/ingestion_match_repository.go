...
func (repository *IngestionMatchRepository) Save(ctx context.Context, match domain.IngestionMatch) error {
	...
	if match.HomeWinOdds != nil || match.DrawOdds != nil || match.AwayWinOdds != nil {
		return repository.matchRepository.UpsertMatchOdds(ctx, ports.MatchOddsUpsertParams{
